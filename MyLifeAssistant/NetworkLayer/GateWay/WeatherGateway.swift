...
struct WeatherGateway {
    let weatherURL = "https://api.openweathermap.org/data/2.5/weather?appid=8e013216062b4a9359d4f6e211b801b3&units=metric"
    
    var delegate: WeatherUseCase?
